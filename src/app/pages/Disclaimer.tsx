  ...
  return (
    <div className="flex flex-col h-screen bg-[#F5F7FA] relative w-full mx-auto font-sans">
      <div className="flex-1 px-6 pt-16 pb-8 flex flex-col items-center">
        ...
        <h1 className="text-[22px] font-bold text-[#1A1A1A] mb-2">运动康复免责声明</h1>
        ...
        >
          <div className="space-y-5">
            <div>
              ...
              <p>本产品为运动康复辅助技术工具，通过硬件传感器与AI算法提供动作引导、评估及方案推荐。<strong className="text-red-500">我们不是医疗机构，不提供医疗服务，不与您形成医患关系。</strong>如您通过平台预约独立康复师或医生，其服务责任完全由该专业人士承担。</p>
            </div>

            <div>
              <p className="font-bold text-[#1A1A1A] text-[15px] mb-1">二、AI推荐与自动调整风险提示</p>
              <p>AI推荐的康复动作及自动参数微调依赖于传感器数据和算法，无法感知您的全部身体状态（如疲劳、代偿）。因此：</p>
              <ul className="list-disc pl-4 space-y-1 mt-1 text-[#6B7280]">
                <li><strong className="text-[#4B5563]">AI推荐效果无任何明示或默示保证</strong>，康复结果因人而异；</li>
            ...
            <div>
              ...
              <p>关节、脊柱等术后用户须满足：切口愈合无感染、已过医生规定制动期、经医生评估允许目标活动度训练。<strong className="text-red-500">首次进入术后模块必须上传康复运动许可并签署知情同意书。</strong>平台仅提供通用禁忌库，不评估个体情况。</p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-4 space-y-1 mt-1 text-[#6B7280]">
                ...
                <li><strong className="text-[#4B5563]">轻度康复动作</strong>（坐位活动、静力收缩等）放宽至<strong className="text-blue-600">14周岁</strong>，14～18周岁须监护人全程陪同并完成可验证的电子知情同意；</li>
                <li><strong className="text-[#4B5563]">65岁以上不建议使用自主训练</strong>，若坚持使用须上传医学评估证明，风险自担；</li>
                <li><strong className="text-[#4B5563]">孕妇、产后6周内</strong>禁止使用；<strong className="text-[#4B5563]">残疾人</strong>需凭康复医师功能评估方可使用部分功能。</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p>平台仅为技术提供方，不参与医疗活动。您通过平台预约的康复师/医生均为独立执业者，临床责任由其自负。远程服务严格限于中国大陆境内，您与提供服务方须确保物理位置均在中国大陆，否则请勿使用。</p>
            </div>
            ...
            <div>
              ...
              <p>您已充分知悉运动康复风险。因隐瞒病史、忽视禁忌、未咨询医生、未遵守年龄/特殊人群限制、延误紧急就医或违反监护人要求而导致的任何伤害，我们不承担责任。本声明未尽事项以《用户服务协议》为准。</p>
            </div>
